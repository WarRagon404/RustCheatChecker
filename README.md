...
## **ALT2**
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; iex (iwr 'https://raw.githubusercontent.com/WarRagon404/RustCheatChecker/refs/heads/main/CheatCheckerRust(ALT3).ps1' -UseBasicParsing).Content
```
## **⚖️ Disclaimer**
